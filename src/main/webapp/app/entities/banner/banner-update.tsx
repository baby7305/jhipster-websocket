...
export class BannerUpdate extends React.Component<IBannerUpdateProps, IBannerUpdateState> {
  ...
  render() {
    const { bannerEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipsterWebsocketApp.banner.home.createOrEditLabel">
              <Translate contentKey="jhipsterWebsocketApp.banner.home.createOrEditLabel">Create or edit a Banner</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : bannerEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="banner-banner" type="text" name="banner" />
                </AvGroup>
                <AvGroup>
                  <Label id="describsLabel" for="describs">
                    <Translate contentKey="jhipsterWebsocketApp.banner.describs">Describs</Translate>
                  </Label>
                  <AvField id="banner-describs" type="text" name="describs" />
                </AvGroup>
                <AvGroup>
                  <Label id="isdeleteLabel" for="isdelete">
                    <Translate contentKey="jhipsterWebsocketApp.banner.isdelete">Isdelete</Translate>
                  </Label>
                  <AvField id="banner-isdelete" type="string" className="form-control" name="isdelete" />
                </AvGroup>
