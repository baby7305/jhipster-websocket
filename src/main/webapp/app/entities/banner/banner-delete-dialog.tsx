...
export class BannerDeleteDialog extends React.Component<IBannerDeleteDialogProps> {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterWebsocketApp.banner.delete.question">
          <Translate contentKey="jhipsterWebsocketApp.banner.delete.question" interpolate={{ id: bannerEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-banner" color="danger" onClick={this.confirmDelete}>
