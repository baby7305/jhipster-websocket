    ...
    return (
      <div>
        <h2 id="banner-heading">
          <Translate contentKey="jhipsterWebsocketApp.banner.home.title">Banners</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterWebsocketApp.banner.home.createLabel">Create new Banner</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jhipsterWebsocketApp.banner.home.search')}
                  />
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('banner')}>
                  <Translate contentKey="jhipsterWebsocketApp.banner.banner">Banner</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('describs')}>
                  <Translate contentKey="jhipsterWebsocketApp.banner.describs">Describs</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('isdelete')}>
                  <Translate contentKey="jhipsterWebsocketApp.banner.isdelete">Isdelete</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {bannerList.map((banner, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{banner.banner}</td>
                  <td>{banner.describs}</td>
                  <td>{banner.isdelete}</td>
